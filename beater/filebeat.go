...
import (
	...
	cfg "github.com/julkipli/filebeat/config"
	"github.com/julkipli/filebeat/crawler"
	"github.com/julkipli/filebeat/fileset"
	"github.com/julkipli/filebeat/publisher"
	"github.com/julkipli/filebeat/registrar"
	"github.com/julkipli/filebeat/spooler"
)
...
func (fb *Filebeat) Run(b *beat.Beat) error {
	...
	logp.Info("Inside 888 Run Method")
	...
	if err != nil {
		logp.Err("Could not init registrar of this: %v", err)
		return err
	}
...
func (fb *Filebeat) Stop() {
	...
	logp.Info("Stopping local **  file beat")
